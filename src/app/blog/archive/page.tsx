              ...
              {years.map((year) => {
                ...
                return (
                  <div key={year} className="relative">
                    {/* Year Header */}
                    <div className="sticky top-20 z-10 bg-[#fcfcfc]/80 backdrop-blur-sm py-4 -mx-6 px-6 mb-6">
                            ...
                            <div className="space-y-3">
                              {monthPosts.map((post) => (
                                <Link
                                  key={post.slug}
                                  href={`/blog/${post.slug}`}
                                  className="group block p-4 rounded-xl bg-white border border-gray-100 hover:border-gray-200 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300"
                                >
